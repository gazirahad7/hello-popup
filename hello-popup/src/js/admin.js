...
jQuery(document).ready(function ($) {
    ...
    $('#popup_image_button').on('click', function (e) {
        ...
        mediaUploader.on('select', function () {
            ...
            $('#hello_popup_image').val(attachment.url);
            $('#popup_image_preview').attr('src', attachment.url).show();
            $('#popup_image_remove').show();
            $('#popup_image_button').hide();
        });

        mediaUploader.open();
    });

    // ❌ Clear image when clicking the “X”
    $('#popup_image_remove').on('click', function () {
        $('#hello_popup_image').val('');
        $('#popup_image_preview').attr('src', '').hide();
        $(this).hide();
        $('#popup_image_button').show();
        $('#popup_image_remove').hide();
        $('.change-image').show();
    });
});
