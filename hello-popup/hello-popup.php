...
// Define constants
if (! defined('HELLO_POPUP_DEV_MODE')) {
    define('HELLO_POPUP_DEV_MODE', true);
}
if (! defined('HELLO_POPUP_VERSION')) {
    define('HELLO_POPUP_VERSION', HELLO_POPUP_DEV_MODE ? time() : '1.0.0');
}
